  ...
  public void run() {
    ...
    while (_$_ != ZERO) {
      ...
      case 1: {
        ...
        while (c3 != ZERO) {
          ...
          case 7:
            ...
            break;
          case 8:
        	  System.out.println("Undo the last Input");
        	  undo();
      ...
      case 2: {
        ...
        File f = new File(KeyConstant.FILE_NAME_SCORE);
        if (!(f.exists() && f.isFile() && f.canRead())) {
          ...
          try {
            ...
            System.out.println(KeyConstant.MSG_WRONG_SCORE);
          }
        }
        try (BufferedReader r = new BufferedReader(new FileReader(f))) // Better to used try with resources like this
        {
